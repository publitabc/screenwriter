...
Paragraph.SetProperties("menu_button_back", { FontScript = global_settings_charset, Text = "[<] "..abc.language[global_settings_language]["BUTTON_BACK"], BorderColor = abc.color.epi, BGColor = abc.color.button_back, ColorNormal = abc.color.black, ColorHighlight = abc.color.grey50, ColorDown = abc.color.grey25, });
...
Paragraph.SetProperties("menu_button_new_location", { FontScript = global_settings_charset, Text = "[L] "..abc.language[global_settings_language]["BUTTON_NEW_LOCATION"], BorderColor = abc.color.epi, BGColor = abc.color.button_back, ColorNormal = abc.color.black, ColorHighlight = abc.color.grey50, ColorDown = abc.color.grey25, });
...
Paragraph.SetProperties("menu_button_new_stage", { FontScript = global_settings_charset, Text = "[S] "..abc.language[global_settings_language]["BUTTON_NEW_SCENE"], BorderColor = abc.color.epi, BGColor = abc.color.button_back, ColorNormal = abc.color.black, ColorHighlight = abc.color.grey50, ColorDown = abc.color.grey25, });
...
Paragraph.SetProperties("menu_wordscounter", { FontScript = global_settings_charset, Text = "", BGColor = abc.color.input_back, BorderColor = abc.color.epi, ColorDisabled = abc.color.black, });
Paragraph.SetProperties("menu_button_previous", { FontScript = global_settings_charset, Text = "", BorderColor = abc.color.epi, BGColor = abc.color.button_back, ColorNormal = abc.color.black, ColorHighlight = abc.color.grey50, ColorDown = abc.color.grey25, });
...
Paragraph.SetProperties("menu_button_next", { FontScript = global_settings_charset, Text = "", BorderColor = abc.color.epi, BGColor = abc.color.button_back, ColorNormal = abc.color.black, ColorHighlight = abc.color.grey50, ColorDown = abc.color.grey25, });
